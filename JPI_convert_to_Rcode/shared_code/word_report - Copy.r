...
winterWithDate$Date <- seq(as.Date("2008-07-01"),as.Date("2009-06-30"),by="7 days")#Changed to 2008-06-30 to make it work
...
geom_text(size=3,aes(x=xloc - 20,y=800,label="*"),data=subset(wintermelt,variable=='BY2013'),inherit.aes=FALSE) +
facet_grid(variable~.) + labs(y="Number of individuals X 1,000",x=paste("\nFigure 1. Weekly estimated passage of juvenile winter Chinook Salmon at Red Bluff Diversion Dam (RK391) by brood-year (BY). Fish were \nsampled using rotary-screw traps for the period" ,xlab, paste("."),paste("\n\n*Winter run passage value interpolated using a monthly mean for the period October 1, 2013 - October 17, 2013 due to government shutdown",paste(".")))) +
...
facet_grid(variable~.) + labs(y="Number of individuals X 1,000",x=paste("\nFigure 2. Weekly estimated passage of juvenile Spring Chinook Salmon at Red Bluff Diversion Dam (RK391) by brood-year (BY). Fish were \nsampled using rotary-screw traps for the period",xlab,paste(".")))  +
theme(axis.title.x = element_text(hjust = -.075))
...
facet_grid(variable~.) + labs(y="Number of individuals X 1,000",x=paste("\nFigure 3. Weekly estimated passage of juvenile Rainbow/Steelhead trout at Red Bluff Diversion Dam (RK391) by brood-year (BY). Fish were \nsampled using rotary-screw traps for the period",xlab,paste(".")))  +
theme(axis.title.x = element_text(hjust = -.075))
...
facet_grid(variable~.) + labs(y="Number of individuals X 1,000",x=paste("\nFigure 4. Weekly estimated passage of juvenile Fall Chinook Salmon at Red Bluff Diversion Dam (RK391) by brood-year (BY). Fish were \nsampled using rotary-screw traps for the period",xlab,paste("."))) +
theme(axis.title.x = element_text(hjust = -.075))
...
axis.text.y=element_text(size=8.2,hjust=1,colour="grey50"),
axis.title.x=element_text(size=9.0),axis.title.y=element_text(size=9.0,angle=90)) +
geom_text(aes(x=xloc,y=50,label=paste("n = ", comma(total))),data=totals,inherit.aes=FALSE,size=3) +
facet_grid(variable~.) + labs(y="Number of individuals X 1,000",x=paste("\nFigure 5. Weekly estimated passage of juvenile Late Fall Chinook Salmon at Red Bluff Diversion Dam (RK391) by brood-year (BY). Fish were \nsampled using rotary-screw traps for the period",xlab,paste("."))) +
theme(axis.title.x = element_text(hjust = -.075))
...
axis.title.x=element_text(size=9.0),axis.title.y=element_text(size=9.0,angle=90)) +
geom_text(aes(x=xloc,y=2500,label=paste("n = ", comma(total))),data=totals,inherit.aes=FALSE,size=3) +
facet_grid(variable~.) + labs(y="Number of individuals X 1,000",x=paste("\nFigure 6. Weekly estimated passage of juvenile Chinook Salmon at Red Bluff Diversion Dam (RK391) by calendar year. Fish were \nsampled using rotary-screw traps for the period",xlab)) +
theme(axis.title.x = element_text(hjust = -.075))
